---
sidebar_position: 3
slug: /examples/Google/vertex-ai-search
---
...
- Optionally store the secret as an [encrypted variable](/docs/configuration/managed-variables)


## Query and retrieve full Gemini response
#### Example Expected Post Payload
