...
For all available `database`  and `document_operation` options see [database inputs](/docs/reference/inputs-database)

See all the available operations under [`document_operation`](/docs/reference/inputs-database#document_operation).
...
## MongoDB Data API example

Source: https://github.com/Tirslo/airpipe-mongodb-data-api

```yml reference title="MongoDB Data API"
https://raw.githubusercontent.com/Tirslo/airpipe-mongodb-data-api/refs/heads/main/config.yml
```