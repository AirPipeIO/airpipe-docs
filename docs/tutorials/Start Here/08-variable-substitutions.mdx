...
- Click <a target="_blank" and rel="noopener noreferrer" href="https://app.airpipe.io/configuration/load?yml=https://raw.githubusercontent.com/AirPipeIO/airpipe-docs/main/docs/tutorials/_yml/08-http-variable-subtitutions-global.yml" style={{ display: 'inline-block', padding: '5px 10px', backgroundColor: '#007bff', color: 'white', textDecoration: 'none', borderRadius: '5px', marginBottom:"5px" }}>Deploy</a>
...
https://github.com/airpipeio/airpipe-docs/blob/main/docs/tutorials/_yml/08-http-variable-subtitutions-global
```
...
### Deploy via Hosted / Managed
- Ensure you are logged into https://app.airpipe.io
- Click <a target="_blank" and rel="noopener noreferrer" href="https://app.airpipe.io/configuration/load?yml=https://raw.githubusercontent.com/airpipeio/airpipe-docs/main/docs/tutorials/_yml/08-http-variable-subtitutions-action.yml" style={{ display: 'inline-block', padding: '5px 10px', backgroundColor: '#007bff', color: 'white', textDecoration: 'none', borderRadius: '5px', marginBottom:"5px" }}>Deploy</a>
...
https://github.com/airpipeio/airpipe-docs/blob/main/docs/tutorials/_yml/08-http-variable-subtitutions-action.yml
```
