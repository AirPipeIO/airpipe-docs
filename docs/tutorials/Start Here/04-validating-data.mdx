...
A highly configurable assertion & test framework is built into the platform for you to leverage, see all the available options **[here](/docs/reference/asserts)**.
...
Review the assertion section **[here](/docs/reference/asserts)**.