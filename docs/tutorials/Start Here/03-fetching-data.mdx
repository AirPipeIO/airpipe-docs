...
We will utilize:
  ...
  - `http` functionality to fetch the data, complete options [here](/docs/reference/inputs-http).
...
https://github.com/airpipeio/airpipe-docs/blob/main/docs/tutorials/_yml/03-http-get-data.yml
```
...
https://github.com/airpipeio/airpipe-docs/blob/main/docs/tutorials/_yml/03-http-post-data.yml
```
