...
**Note** we are also using blowfish encryption in this example to validate the password, see [verify_bcrypt](/docs/configuration/interfaces/actions/asserts/functions#bcrypt-verify).
