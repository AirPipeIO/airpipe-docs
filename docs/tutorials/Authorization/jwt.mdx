...
We will use the [add_jwt](/docs/reference/transforms#type-addjwt) functionality.

**Note** we are also using blowfish encryption in this example to validate the password, see [verify_bcrypt](/docs/reference/asserts#type-test).
    ...
    actions:
      ...
      - name: VerifyPassword
        ...
        assert:
          ...
          tests:
              - value: pass
                verify_bcrypt: a|GetUserDetails::password|
        post_transforms:
          - remove_attributes:
              - $.pass
          - add_jwt:
