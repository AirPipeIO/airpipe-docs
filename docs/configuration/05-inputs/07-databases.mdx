...
https://github.com/airpipeio/airpipe-docs/blob/main/docs/examples/_ex_ymls/_databases_/mongodb-find.yml
```
...
https://github.com/airpipeio/airpipe-docs/blob/main/docs/examples/_ex_ymls/_databases_/mongodb-aggregate.yml
```
