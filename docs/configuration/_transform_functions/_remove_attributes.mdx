...
https://github.com/airpipeio/airpipe-docs/blob/main/docs/examples/_ex_ymls/_transforms_/remove_attributes-object.yml
```
...
https://github.com/airpipeio/airpipe-docs/blob/main/docs/examples/_ex_ymls/_transforms_/remove_attributes-array.yml
```
