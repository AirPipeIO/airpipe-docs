...
Detailed information for Globals and usage can be found [here](./configurations/globals)
...
Detailed information for Interfaces its options and usage can be found [here](./configurations/interfaces)