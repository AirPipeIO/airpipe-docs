...
> For all database options and information on defining your connection strings view the [database options under input.](/docs/configuration/interfaces/actions/inputs/databases)
