...
Templates support variables and parameters using the same syntax `a|var::variable|` or `$3`. See [Interpolation](/docs/configuration/interpolation) for the full syntax.
...
For more details on how to use the **email** input see the [documentation](/docs/reference/inputs-email).
