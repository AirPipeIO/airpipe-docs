...
const PAGES = [
  ...
  },
  {
    ...
    defs: ["Transform", "TransformConfig", "CustomTransform", "TransformExtractArray",
      ...
      "DecryptValue", "GenerateBytes", "ExtractWithRegex", "ExtractWithCss", "TransformCompress",
      "TransformDecompress", "TransformParseXlsx", "TransformParsePdf", "TransformTotp",
      "S3GeneratePresignedURL", "MathEvalType", "DataType"],
  },
  {
    file: "12-asserts",
    title: "Asserts & tests",
    defs: ["Assert", "Test", "ContainOptions", "ContainsAny", "ContainsAdv", "JwtConfig",
      "JwtVerifyConfig", "IsValidHmacConfig", "IsValidTotpConfig", "CompareValue", "CompareDataType",
